...
let DashboardComponent = class DashboardComponent {
    ...
    updateData() {
        ...
        setInterval(() => { this.getAllData(); this.getStateWiseData(); }, 30000);
    }
    ngAfterViewInit() {
...
let GraphService = class GraphService {
    ...
    updateChart() {
        return this.http.get(src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].graphDataUrl)
            .toPromise()
            .then((res) => {
            console.log(res);
        })
